...
import application.FileControls;
...
public class MyController{
	...
	private void fileOpen() {
		File selectedFile = application.FileControls.fileOpenConf();
		if (selectedFile != null) {
			textEditor.setText(application.FileControls.readFile(selectedFile));
		}
	}

	@FXML
	private void fileSaveAs() {
		File selectedFile = application.FileControls.fileSaveAsConf();
		if (selectedFile != null) {
			application.FileControls.writeFile(selectedFile, textEditor.getParagraphs());
		}
	}
